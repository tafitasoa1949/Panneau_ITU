...
<%
    Secteur[] listSecteur = (Secteur[]) request.getAttribute("listSecteur");
%>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="content-wrapper">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">Voir prevision</div>
                                <hr>
                                <form action="<%= request.getContextPath() %>/ResultServlet">
                                    <div class="form-group">
                                        <label for="input-1">Date</label>
                                        <input type="date" class="form-control" id="input-1"  name="date">
                                    </div>
                                    <div class="form-group">
                                     <button type="submit" class="btn btn-light px-5"><i class="icon-eye"></i> Voir</button>
                                   </div>
                                </form>
                            </div>
                        </div>
